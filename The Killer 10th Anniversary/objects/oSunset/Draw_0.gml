if (USE_MULTIPLY_BLENDMODE) {
	...
	if(!variable_global_exists("sunset_overlay_surface") || !surface_exists(global.sunset_overlay_surface)) {
		global.sunset_overlay_surface = surface_create(room_width, room_height + 10); // +10 here is to give a little buffer to prevent artifacts on certain resolutions.
	}	
	...
	draw_surface(global.sunset_overlay_surface, 0, y - 5);
